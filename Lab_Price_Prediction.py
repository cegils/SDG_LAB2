...
plt.subplot(313)
plt.plot(p_target_test[:1,:7,:].flatten(), color='blue', label='actual price')
plt.plot(predict_nn_model_3[:1,:7,:].flatten(), color='black', label='forecast Model 3, mse: %.2f' % mse_3)
plt.xlabel('Hour of the Day')
plt.ylabel('Prices')
plt.legend(frameon=True)
plt.show()
...
plt.legend(frameon=True)
plt.subplot(313)
plt.plot(predict_nn_model_3[2:3,:1,:].flatten(), color='black', label='Day predicted w3')
plt.xlabel('Hour of the Day')
plt.ylabel('Prices')
plt.legend(frameon=True)
plt.show()
...
pred_2 = predict_nn_model_3[1:2,:1,:].reshape(24).tolist()
pred_3 = predict_nn_model_3[2:3,:1,:].reshape(24).tolist()
